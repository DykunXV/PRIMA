namespace Script {
  ...
  export class DropToGroundInitial extends ƒ.ComponentScript {
    ...
    private setPosition = (): void => {
      const graph: ƒ.Graph = ƒ.Project.resources["Graph|2022-04-12T15:10:16.404Z|44825"] as ƒ.Graph;
      const ground: ƒ.Node = 
      graph.getChildrenByName("Environment")[0].getChildrenByName("Ground")[0];
